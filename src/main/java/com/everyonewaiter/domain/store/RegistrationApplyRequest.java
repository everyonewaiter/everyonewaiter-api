...
@Schema(name = "RegistrationApplyRequest")
public record RegistrationApplyRequest(
    ...
    @Schema(description = "사업자 등록증 파일", example = "business_license.pdf", requiredMode = REQUIRED)
