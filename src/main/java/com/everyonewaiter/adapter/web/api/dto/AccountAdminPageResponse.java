...
@Schema(name = "AccountAdminPageResponse")
public record AccountAdminPageResponse(
  ...
  public static AccountAdminPageResponse from(AccountAdminPageView adminPageView) {
