...
@Tag(name = "기기")
interface DeviceManagementApiSpecification {
  ...
  ResponseEntity<Paging<DevicePageResponse>> getDevices(
      Long storeId,
      @ParameterObject DevicePageRequest pageRequest,
  ...
  ResponseEntity<DeviceDetailResponse> getDevice(
      Long storeId,
      Long deviceId,
      @Parameter(hidden = true) Account account
  );
  ...
  ResponseEntity<DeviceCreateResponse> create(
      Long storeId,
      @RequestBody DeviceCreateRequest createRequest
  );
